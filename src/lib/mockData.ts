...
export const generateWasteDistribution = () => [
  { name: "Recyclable", value: 45, fill: "hsl(var(--chart-1))" },
  { name: "Organic", value: 25, fill: "hsl(var(--chart-4))" },
  { name: "Landfill", value: 20, fill: "hsl(var(--muted))" },
  { name: "Hazardous", value: 5, fill: "hsl(var(--chart-5))" },
  { name: "Manual", value: 5, fill: "hsl(var(--contamination))" },
];
