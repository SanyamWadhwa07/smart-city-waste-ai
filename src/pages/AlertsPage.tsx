...
const alertStyles = {
  warning: {
    badge: "bg-warning/20 text-warning border-warning/50",
    icon: "text-warning",
  },
  critical: {
    badge: "bg-contamination/20 text-contamination border-contamination/50",
    icon: "text-contamination",
  },
  info: {
      ...
      <div className="space-y-8">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            <Badge variant="outline" className="bg-contamination/20 text-contamination border-contamination/50 px-3 py-1.5">
              {alerts.filter((a) => a.type === "critical" && !a.resolved).length} Critical
            </Badge>
            <Badge variant="outline" className="bg-warning/20 text-warning border-warning/50 px-3 py-1.5">
