...
export function ImpactCalculator() {
  ...
  return (
    <Card className="pro-card max-w-3xl mx-auto">
      <CardHeader>
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              ...
              <span className="text-lg font-semibold text-warning">{contaminationRate}%</span>
            </div>
            <Slider
              id="contamination"
              min={5}
        ...
        <div className="grid sm:grid-cols-2 gap-4 pt-6 border-t border-border/50">
          <div className="flex items-center gap-4 p-4 rounded-lg bg-success/10 border border-success/30">
            ...
            <div>
              ...
              <p className="text-2xl font-bold text-success">{co2Savings} kg/day</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4 p-4 rounded-lg bg-primary/10 border border-primary/30">
            ...
            <div>
              ...
              <p className="text-2xl font-bold text-primary">${revenuePotential}/day</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4 p-4 rounded-lg bg-accent/10 border border-accent/30">
            ...
            <div>
              ...
              <p className="text-2xl font-bold text-accent">{laborReduction}%</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4 p-4 rounded-lg bg-warning/10 border border-warning/30">
            ...
            <div>
              ...
              <p className="text-2xl font-bold text-warning">-{contaminationReduction}%</p>
            </div>
          </div>
        </div>
      </CardContent>
