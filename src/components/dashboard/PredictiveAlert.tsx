...
export function PredictiveAlert({
  ...
  return (
    <Card className="glass-card border-accent/50 pulse-alert overflow-hidden">
            ...
            <div className="mt-3 grid grid-cols-2 md:grid-cols-4 gap-3 text-sm">
              <div className="flex items-center gap-2">
                ...
                <span className="font-medium">
                  {historicalRate}% → <span className="text-destructive">{currentRate}%</span>
                </span>
              </div>
              <div className="col-span-2 md:col-span-1 flex items-center gap-2">
                <DollarSign className="h-4 w-4 text-destructive" />
                <span className="text-muted-foreground">Impact:</span>
                <span className="font-medium text-destructive">{impactDaily}/day</span>
              </div>
              <div className="flex items-center gap-2">
                <Leaf className="h-4 w-4 text-destructive" />
                <span className="text-muted-foreground">CO₂:</span>
                <span className="font-medium text-destructive">{co2Impact} kg/day</span>
              </div>
            </div>
