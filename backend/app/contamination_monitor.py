...
"""
Contamination Prevention & Monitoring Module

Tracks three key signals from the dual-agent system:
1. Contamination flags - Items where agents disagree on material/routing
2. Agent conflicts - Primary detector vs secondary classifier mismatches
3. Low confidence - Detections below adaptive threshold

Provides rolling metrics and alerts for operational oversight.
"""
